        ...
        <div className="lg:pt-28 md:pt-20 pt-10 bg-gradient-to-r from-red-700 via-[#ff9046] to-red-700">
            <div className="container">
                ...
                <div className="flex justify-center items-center md:gap-x-24 gap-x-10 mt-10 mb-5">
                    <a href="https://www.facebook.com/ahmedraza1161/" target="_blank">
                        <Image src={Facebook} alt="Icons" width={30} height={30} />
                    </a>
                    <a href="https://x.com/ahmedraza1161/" target="_blank">
                        <Image src={Twitter} alt="Icons" width={30} height={30} />
                    </a>
                    <a href="https://www.instagram.com/ahmedraza1161/" target="_blank">
                        <Image src={Instagram} alt="Icons" width={30} height={30} />
                    </a>
                    <a href="https://api.whatsapp.com/send?phone=03187380601" target="_blank">
                        <Image src={Whatsapp} alt="Icons" width={30} height={30} />
                    </a>
                </div>
