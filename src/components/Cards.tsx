  ...
  const animateCard = [
    {
      ...
      desc: "Authoring semantic, accessible HTML that anchors every build with clean structure, clear content hierarchy, and SEO-ready markup.",
    ...
    },
    {
      ...
      afterBg: CSS3,
      title: "CSS & Styling",
      desc: "Designing responsive, pixel-perfect interfaces with Tailwind CSS, custom design systems, and modern layout techniques such as Grid and Flexbox.",
    ...
    },
    {
      ...
      desc: "Building interactive front-end experiences with modern JavaScript (ES6+), React, and Next.js, optimized for performance and maintainability.",
    ...
    },
    {
      ...
      afterBg: UI,
      title: "UI/UX Design",
      desc: "Shaping intuitive user journeys with design libraries like shadcn/ui, Magic UI, and Material UI, while leveraging Framer Motion for purposeful animation.",
      bfGredient: "bg-gradient-to-tr from-[#4dff03] to-[#00d0ff]",
      afGredient: "bg-gradient-to-tr from-[#4dff03] to-[#00d0ff]",
    },
    {
      ...
      desc: "Integrating modern backends including Supabase, Convex, Neon, and MongoDB to deliver reliable, real-time data layers for web products.",
    ...
    },
    {
      ...
      desc: "Orchestrating end-to-end delivery with GitHub workflows, API design, and cloud-ready deployments that keep projects moving from prototype to production.",
